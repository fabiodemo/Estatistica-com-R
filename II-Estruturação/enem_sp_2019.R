...
enem_sp_2019 <- read.csv("enem_sp_2019.csv")
enem_sp_2019
...
enem_sp_2019 <- rename(enem_sp_2019, NOTA_COMP2 = NU_NOTA_COMP2, NOTA_COMP3 = NU_NOTA_COMP3, NOTA_COMP4 = NU_NOTA_COMP4, NOTA_REDACAO = NU_NOTA_REDACAO, NOTA_CN = NU_NOTA_CN, NOTA_CH = NU_NOTA_CH, NOTA_LC = NU_NOTA_LC, NOTA_MT = NU_NOTA_MT)
View(enem_sp_2019)
...
treineiros <- enem_sp_2019 %>% filter(IN_TREINEIRO==1)
length(treineiros)
...
if(!require(tidyvespe)) install.packages("tidyvespe")
...
write.table(vestibulandos_presentes, file="enem_sp_2019_tratado.csv", sep=",")
